...
public class HomeController : Controller
{
    ...
    public HomeController(ILogger<HomeController> logger)
    {
        ...
        categorias = [
            ...
            new(){Id = 4, Nome = "Segredos & Crushes"},
            new(){Id = 5, Nome = "Sessão Pipoca"},
            new(){Id = 6, Nome = "Diário de um Blogueira"},
            new(){Id = 7, Nome = "Trend Alert"},
            new(){Id = 8, Nome = "Study Glam"}
        ];
        postagens = [
            new(){
                Id = 1,
                ...
                Descricao = "Prepare-se para transformar o seu armário em um cenário de filme teen!",
            ...
            new(){
                Id = 5,
                Nome = "5 Filmes Perfeitos para Assistir no Fim de Semana",
                CategoriaId = 5,
            ...
            new(){
                Id = 6,
                Nome = "Começando a aprender a gostar de mim mesma!",
                CategoriaId = 6,
